    ...
    return(<>
        <div className="relative min-h-screen bg-cover flex flex-col items-center justify-center p-5 dark:bg-dark-bg bg-light-bg">
            <Navbar/>
                ...
                <h2 className="animate-fade-down animate-once animate-duration-300 animate-ease-in-out animate-delay-100 md:text-4xl text-2xl  dark:text-dark-aqua text-light-aqua font-semibold mt-2 mb-10">(jarvx)</h2>
